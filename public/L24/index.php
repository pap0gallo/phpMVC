...
$repo = new App\L24\src\PostRepository();
$router = $app->getRouteCollector()->getRouteParser();

// BEGIN (write your solution here)
$hashMiddleware = function (Request $request, RequestHandler $handler): ResponseInterface {
    ...
    return $response->withHeader('X-Content-Hash', $hash);
};
...
$app->post('/posts', function ($request, $response) use ($repo, $router) {
    ...
    $validator = new App\L24\src\Validator();
